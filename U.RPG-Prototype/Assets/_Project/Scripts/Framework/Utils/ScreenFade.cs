...
namespace ANM.Framework.Utils
{
    ...
    public class ScreenFade : MonoBehaviour
    {
        ...
        private void OnStartLoadScene(bool fade, bool save)
        {
            // Debug.Log("[ScreenFade]: OnStartLoadScene");
        ...
        private void OnFinishLoadScene(bool fade, bool save)
        {
            // Debug.Log("[ScreenFade]: OnFinishLoadScene");
